...
if(confirm("삭제하시겠습니까?")){
document.form1.action="/project/shop/product/delete.do";
...
document.form1.action="/project/shop/product/update.do";
document.form1.submit();
}
</script>
</head>
...
<td>상품이미지</td>
<td>
<img src="/project/images/${dto.filename}" width="300px"height="300px">
<br>
